...
Private cTitRpt := "Relação de despesas nacionais" //FDR 08/12/2016
Private nFase   := 2
Private nAgrup  := 1
...
IF Empty(cTitRpt)
   cTitRpt := "Relação de Despesas Nacionais"  //LRS - 27/07/2016
EndIF
...
Begin Sequence
   ...
   DEFINE MSDIALOG oDlg TITLE "Relação de Despesas Nacionais" FROM AVG_CORD(250),AVG_CORD(214) TO AVG_CORD(645),AVG_CORD(530) PIXEL
      ...
      @ AVG_CORD(nLin5),AVG_CORD(nCol2) Say "Código :" Size AVG_CORD(021),AVG_CORD(008) PIXEL OF oPanel
      ...
      @ AVG_CORD(nLin12),AVG_CORD(nCol1) TO AVG_CORD(nLin14),AVG_CORD(nCol11) LABEL "Desembaraço" PIXEL OF oPanel
