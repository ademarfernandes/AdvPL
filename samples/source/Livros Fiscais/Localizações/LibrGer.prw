...
#IFDEF TOP
   If TcSrvType() != "AS/400"
      ...
      cQuery += "D_E_L_E_T_<>'*' "
      If lAmbos
         cQuery += "ORDER BY F3_FILIAL,F3_TIPOMOV,F3_ENTRADA,"+SerieNfId("SF3",3,"F3_SERIE")+",F3_NFISCAL"      
      Else
         cQuery += "ORDER BY F3_FILIAL,F3_ENTRADA,"+SerieNfId("SF3",3,"F3_SERIE")+",F3_NFISCAL"
      EndIf      
...
#ELSE
   ...
   If lAmbos
      cChave    := "F3_FILIAL+F3_TIPOMOV+DTOS(F3_ENTRADA)+"+SerieNfId("SF3",3,"F3_SERIE")+"+F3_NFISCAL"
   Else 
...
While !Eof() 
   ...
   If Len(aImpostos) == 0  //TES nao possui impostos relacionados
      Aadd(aRelImps,{SerieNfId(cAliasSF3,2,'F3_SERIE'),(cAliasSF3)->F3_NFISCAL,{}})            
   Else
      Aadd(aRelImps,{SerieNfId(cAliasSF3,2,'F3_SERIE'),(cAliasSF3)->F3_NFISCAL,{}})            
      ...
      Next nX      
   EndIf   
   Aadd(aRegSF3,{(cAliasSF3)->F3_ENTRADA,(cAliasSF3)->F3_ESPECIE,SerieNfId(cAliasSF3,2,'F3_SERIE'),;
